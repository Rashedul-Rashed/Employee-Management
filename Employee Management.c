...
//Creating or adding linked list continuously
...
void insert_after_postiton()
{
    ...
    //if ID not matched or not found then this message will be show
    if (flag == 0)
    {
        printf("ID not found!\n");
    }
...
//     //if database is empty then this message will be show
//     if (head == NULL)
//     {
...
int main()
{
    ...
    double salary;
    printLogo(); //call print logo function.
    while (1)
    {
        ...
        printf("Password: ");
        gets(pass);
        if (loginCheck(name, pass)) /*calling login check function for check input user name and password validity*/
        {
            /*This is dashboard section after successful login*/
            while (1)
            {
                ...
                printf("1.Add New\n2.List\n3.Exit\n4.Modify\n5.Search\n6.Delete\n");
                printf("\nSalGenR>> ");
                scanf("%d", &option); //searching key for main menu
                switch (option)
                {
                case 1:
                    system("cls");
                    printf("\nChoose Option.\n");
                    printf("--------------\n");
                    printf("1.Add Employee Continuously.\n");
                ...
                case 4:
                    ...
                    printf("5.Modify by Salary\n");
                    printf("6.Modify by Address\n");
                    printf("7.Back\n");
                    printf("\nModify>> ");
                    scanf("%d", &option3);
                    if (option3 == 7)
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        if (modify_Employee_Age() == true)
                            change_Records(mod);
                        break;
                    case 4:
                        if (modify_Employee_pnumber() == true)
                            change_Records(mod);
                        break;
                    default:
